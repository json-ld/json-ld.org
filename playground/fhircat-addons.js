...
globalThis.FHIRValuesetMap = require('./R5-Valuesets-no-ws').entry.reduce(indexFhir, {});
globalThis.FhirJsonLdContextGenerator = require('../fhirlib/FhirJsonLdContextModelVisitor');
