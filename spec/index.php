...
<body>
 <div class="navbar navbar-static-top">
  ...
  </a> <a class="brand" href="../index.html"><img src="../images/json-ld-data-24.png">
  JSON-LD</a>
  <div class="nav-collapse">
   <ul class="nav">
    <li><a href="../playground/index.html"><span class="icon-beer"></span>
      Play</a></li>
      <li><a href="../learn.html"><span class="icon-book"></span>
        Documentation</a></li>
        <!-- <li><a href="#"><span class="icon-beaker"></span> Developers</a></li> -->
        <li class="dropdown"><a href="#" class="dropdown-toggle"
         data-toggle="dropdown"><span class="icon-folder-open"></span>
         Specifications <b class="caret"></b></a>
        ...
        <li><a href="../images/index.html"><span class="icon-picture"></span>
          Branding</a></li>
        </ul>
      </div>
      <!--/.nav-collapse -->
